...
public class PersonalController {
    ...
    @Resource
    private HardwareMallUserService hardwareMallUserService;
    ...
    public Result login(@RequestParam("loginName") String loginName,
        ...
        //todo 清verifyCode
        String loginResult = hardwareMallUserService.login(loginName, MD5Util.MD5Encode(password, "UTF-8"), httpSession);
        //登录成功
    ...
    public Result register(@RequestParam("loginName") String loginName,
        ...
        //todo 清verifyCode
        String registerResult = hardwareMallUserService.register(loginName, password);
        //注册成功
    ...
    public Result updateInfo(@RequestBody MallUser mallUser, HttpSession httpSession) {
        HardwareMallUserVO mallUserTemp = hardwareMallUserService.updateUserInfo(mallUser,httpSession);
